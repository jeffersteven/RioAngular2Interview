## My firts application with angular 2 using webpack and Sass.
### This app is a challenge for interview in Rio de Janeiro for a Front end developer.
Mission:
Reimplement the Pluga's widget in Angular 2 using a mock API.

#### Jefferson Castañeda.

#### Below the information and project that was taken as base.
